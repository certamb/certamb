...
public class DetalleTransaccionClienteAdapter implements DetalleTransaccionClienteModel {
	...
	protected DetalleTransaccionClienteEntity detalleTransaccionClienteEntity;
	...
	public static DetalleTransaccionClienteEntity toDetalleTransaccionClienteEntity(DetalleTransaccionClienteModel model, EntityManager em) {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((getTransaccionCliente() == null) ? 0 : getTransaccionCliente().hashCode());

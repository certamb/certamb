...
public class TransaccionCompraVentaAdapter implements TransaccionCompraVentaModel {
    ...
    public TransaccionCompraVentaAdapter(EntityManager em,
            TransaccionCompraVentaEntity transaccionCompraVentaEntity) {
        this.em = em;
    ...
    public static TransaccionCompraVentaEntity toTransaccionCompraVentaEntity(
            TransaccionCompraVentaModel model, EntityManager em) {
    ...
    public List<DetalleTransaccionClienteModel> getDetalle() {
        Set<DetalleTransaccionClienteEntity> detalleTransaccionClienteEntities = transaccionCompraVentaEntity
                .getDetalle();

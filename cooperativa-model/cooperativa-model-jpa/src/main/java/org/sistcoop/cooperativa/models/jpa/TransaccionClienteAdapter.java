...
public class TransaccionClienteAdapter implements TransaccionClienteModel {
	...
	public static TransaccionClienteEntity toTransaccionClienteEntity(TransaccionClienteModel model, EntityManager em) {
	...
	public List<DetalleTransaccionClienteModel> getDetalle() {
		Set<DetalleTransaccionClienteEntity> detalleTransaccionClienteEntities = transaccionClienteEntity.getDetalle();

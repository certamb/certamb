 ...
 * */
@NamedQueries(value = {
		@NamedQuery(name = "Boveda.getByAgencia", query = "SELECT b FROM BovedaEntity b WHERE b.agencia = :agencia"),
		@NamedQuery(name = "Boveda.getByAgenciaFilterText", query = "SELECT b FROM BovedaEntity b WHERE b.agencia = :agencia AND b.denominacion LIKE :filterText"),

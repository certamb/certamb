...
public class TransaccionCajaCajaAdapter implements TransaccionCajaCajaModel {
    ...
    public static TransaccionCajaCajaEntity toTransaccionCajaCajaEntity(TransaccionCajaCajaModel model,
            EntityManager em) {
    ...
    public List<DetalleTransaccionCajaCajaModel> getDetalle() {
        Set<DetalleTransaccionCajaCajaEntity> detalleTransaccionCajaCajaEntities = transaccionCajaCajaEntity
                .getDetalle();
    ...
    public int hashCode() {
        ...
        result = prime
                * result
                + ((getHistorialBovedaCajaDestino() == null) ? 0 : getHistorialBovedaCajaDestino().hashCode());
        result = prime * result
                + ((getHistorialBovedaCajaOrigen() == null) ? 0 : getHistorialBovedaCajaOrigen().hashCode());

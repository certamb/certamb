...
public class TransaccionMayorCuantiaAdapter implements TransaccionMayorCuantiaModel {
    ...
    private TransaccionMayorCuantiaEntity transaccionMayorCuantiaEntity;
    private EntityManager em;

    public TransaccionMayorCuantiaAdapter(EntityManager em,
            TransaccionMayorCuantiaEntity transaccionMayorCuantiaEntity) {
        this.em = em;
    ...
    public static TransaccionMayorCuantiaEntity toTransaccionMayorCuantiaEntity(
            TransaccionMayorCuantiaModel model, EntityManager em) {

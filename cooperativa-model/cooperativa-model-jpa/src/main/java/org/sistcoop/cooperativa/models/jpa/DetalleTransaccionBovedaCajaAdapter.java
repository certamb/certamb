...
public class DetalleTransaccionBovedaCajaAdapter implements DetalleTransaccionBovedaCajaModel {
	...
	protected DetalleTransaccionBovedaCajaEntity detalleTransaccionBovedaCajaEntity;
	protected EntityManager em;

	public DetalleTransaccionBovedaCajaAdapter(EntityManager em, DetalleTransaccionBovedaCajaEntity detalleTransaccionBovedaCajaEntity) {
		this.em = em;
	...
	public static DetalleTransaccionBovedaCajaEntity toDetalleTransaccionBovedaCajaEntity(DetalleTransaccionBovedaCajaModel model, EntityManager em) {
	...
	public TransaccionBovedaCajaModel getTransaccionBovedaCaja() {
		return new TransaccionBovedaCajaAdapter(em, detalleTransaccionBovedaCajaEntity.getTransaccionBovedaCaja());
	}

...
public class ModelToRepresentationTest extends AbstractTest {
	...
	public void transaccionEntidadBoveda() {
		...
		TransaccionEntidadBovedaModel transaccionEntidadBoveda1 = transaccionEntidadBovedaProvider.create(entidad,
				historialBoveda, OrigenTransaccionEntidadBoveda.BOVEDA,
		...
		TransaccionEntidadBovedaRepresentation rep1 = ModelToRepresentation.toRepresentation(transaccionEntidadBoveda1);
		TransaccionEntidadBovedaRepresentation rep2 = ModelToRepresentation.toRepresentation(transaccionEntidadBoveda2);
	...
	public void transaccionBovedaCaja() {
		...
		TransaccionBovedaCajaModel transaccionBovedaCaja1 = transaccionBovedaCajaProvider.create(historialBoveda,
				historialBovedaCaja, OrigenTransaccionBovedaCaja.BOVEDA, "Sin observacion");
		TransaccionBovedaCajaModel transaccionBovedaCaja2 = null;

		TransaccionBovedaCajaRepresentation rep1 = ModelToRepresentation.toRepresentation(transaccionBovedaCaja1);
		TransaccionBovedaCajaRepresentation rep2 = ModelToRepresentation.toRepresentation(transaccionBovedaCaja2);
	...
	public void transaccionCajaCaja() {
		...
		TransaccionCajaCajaModel transaccionCajaCaja1 = transaccionCajaCajaProvider.create(historialBovedaCaja1,
				historialBovedaCaja2, BigDecimal.TEN, "Sin observacion");
	...
	public void detalleMonedaTransaccionEntidadBoveda() {
		...
		BovedaModel boveda = bovedaProvider.create("Agencia 01", "PEN", "Boveda Nuevos Soles");
		HistorialBovedaModel historialBoveda = historialBovedaProvider.create(boveda);
		TransaccionEntidadBovedaModel transaccionEntidadBoveda = transaccionEntidadBovedaProvider.create(entidad,
				historialBoveda, OrigenTransaccionEntidadBoveda.BOVEDA,
				TipoTransaccionEntidadBoveda.MOVIMIENTO_BANCARIO, "Sin observacion");
		...
		DetalleMonedaRepresentation rep1 = ModelToRepresentation.toRepresentation(detalleTransaccionEntidadBoveda1);
		DetalleMonedaRepresentation rep2 = ModelToRepresentation.toRepresentation(detalleTransaccionEntidadBoveda2);
	...
	public void detalleMonedaTransaccionBovedaCaja() {
		...
		HistorialBovedaModel historialBoveda = historialBovedaProvider.create(boveda);
		HistorialBovedaCajaModel historialBovedaCaja = historialBovedaCajaProvider.create(bovedaCaja);
		TransaccionBovedaCajaModel transaccionBovedaCaja = transaccionBovedaCajaProvider.create(historialBoveda,
				historialBovedaCaja, OrigenTransaccionBovedaCaja.BOVEDA, "Sin observacion");
		...
		DetalleMonedaRepresentation rep1 = ModelToRepresentation.toRepresentation(detalleTransaccionBovedaCaja1);
		DetalleMonedaRepresentation rep2 = ModelToRepresentation.toRepresentation(detalleTransaccionBovedaCaja2);
	...
	public void detalleMonedaTransaccionCajaCaja() {
		...
		HistorialBovedaCajaModel historialBovedaCaja1 = historialBovedaCajaProvider.create(bovedaCaja1);
		HistorialBovedaCajaModel historialBovedaCaja2 = historialBovedaCajaProvider.create(bovedaCaja2);
		TransaccionCajaCajaModel transaccionCajaCaja = transaccionCajaCajaProvider.create(historialBovedaCaja1,
				historialBovedaCaja2, BigDecimal.TEN, "Sin observacion");
		...
		DetalleMonedaRepresentation rep1 = ModelToRepresentation.toRepresentation(detalleTransaccionCajaCaja1);
		DetalleMonedaRepresentation rep2 = ModelToRepresentation.toRepresentation(detalleTransaccionCajaCaja2);
	...
	public void detalleHistorialBoveda() {
		BovedaModel boveda = bovedaProvider.create("Agencia 01", "PEN", "Boveda Nuevos Soles");
		HistorialBovedaModel historialBoveda = historialBovedaProvider.create(boveda);
		DetalleHistorialBovedaModel detalleHistorialBoveda1 = detalleHistorialBovedaProvider.create(historialBoveda,
				BigDecimal.TEN, 1000);

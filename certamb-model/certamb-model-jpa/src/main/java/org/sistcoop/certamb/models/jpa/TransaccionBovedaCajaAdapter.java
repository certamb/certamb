...
import org.sistcoop.certamb.models.jpa.entities.DetalleTransaccionBovedaCajaEntity;
...
public class TransaccionBovedaCajaAdapter implements TransaccionBovedaCajaModel {
    ...
    public TransaccionBovedaCajaAdapter(EntityManager em,
            TransaccionBovedaCajaEntity transaccionBovedaCajaEntity) {
        this.em = em;
    ...
    public static TransaccionBovedaCajaEntity toTransaccionBovedaCajaEntity(TransaccionBovedaCajaModel model,
            EntityManager em) {
    ...
    public List<DetalleTransaccionBovedaCajaModel> getDetalle() {
        Set<DetalleTransaccionBovedaCajaEntity> detalleTransaccionBovedaCajaEntities = transaccionBovedaCajaEntity
                .getDetalle();
    ...
    public int hashCode() {
        ...
        result = prime * result
                + ((getHistorialBovedaCaja() == null) ? 0 : getHistorialBovedaCaja().hashCode());

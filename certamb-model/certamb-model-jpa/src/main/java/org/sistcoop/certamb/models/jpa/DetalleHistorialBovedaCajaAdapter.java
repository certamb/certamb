...
public class DetalleHistorialBovedaCajaAdapter implements DetalleHistorialBovedaCajaModel {
    ...
    private DetalleHistorialBovedaCajaEntity detalleHistorialBovedaCajaEntity;
    private EntityManager em;

    public DetalleHistorialBovedaCajaAdapter(EntityManager em,
            DetalleHistorialBovedaCajaEntity detalleHistorialBovedaCajaEntity) {
        this.em = em;
    ...
    public static DetalleHistorialBovedaCajaEntity toCajaEntity(DetalleHistorialBovedaCajaModel model,
            EntityManager em) {

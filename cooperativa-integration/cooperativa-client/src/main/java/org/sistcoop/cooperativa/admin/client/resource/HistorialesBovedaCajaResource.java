...
public interface HistorialesBovedaCajaResource {
	 ...
	 * SearchResultsRepresentation<HistorialBovedaCajaRepresentation> search(
	 * 
	...
	@Path("search")
	@Produces(MediaType.APPLICATION_JSON)
	public SearchResultsRepresentation<HistorialBovedaCajaRepresentation> search(SearchCriteriaRepresentation criteria);

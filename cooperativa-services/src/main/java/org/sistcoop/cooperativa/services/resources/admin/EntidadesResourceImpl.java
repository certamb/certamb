...
public class EntidadesResourceImpl implements EntidadesResource {
    ...
    @Override
    public SearchResultsRepresentation<EntidadRepresentation> search(String denominacion, String abreviatura,
        ...
        if (filterText == null) {
            results = entidadProvider.search(searchCriteriaBean);
        } else {
